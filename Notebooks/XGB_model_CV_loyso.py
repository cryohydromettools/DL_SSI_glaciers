...
path_xgb = '../XGB/LOYSO_ERA5/CV/'
path_xgb_fig = '../XGB/LOYSO_ERA5/CV_FIG/'
...
for j in range(0, n_folds):
    ...
    ax0.legend(loc='best')
    fig.savefig(path_xgb_fig + str(j+1) + '_score_XGB_year_stake.png',dpi = 150,
...
fig.savefig('../fig/rmse_XGB_loyso.png',dpi = 150, bbox_inches = 'tight', 
