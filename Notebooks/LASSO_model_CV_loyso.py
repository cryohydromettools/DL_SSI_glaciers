...
path_rf = '../LASSO/LOYSO_ERA5/CV/'
path_rf_fig = '../LASSO/LOYSO_ERA5/CV_FIG/'
...
for j in range(0, n_folds):
    ...
    model = LassoCV(cv=15).fit(X_train, y_train)
...
fig.savefig('../fig/rmse_LASSO_loyso.png',dpi = 150, bbox_inches = 'tight', 
